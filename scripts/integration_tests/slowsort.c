...
/* implementation of slowsort on integers, based on
 * https://en.wikipedia.org/wiki/Slowsort */
void i_slowsort(int arr[10], int i, int j)
{
	if (i >= j) {
		return;
	}
...
/* implementation of slowsort on floats, based on
 * https://en.wikipedia.org/wiki/Slowsort */
void f_slowsort(float arr[10], int i, int j)
{
	if (i >= j) {
		return;
	}
...
void print_i_array(int arr[10], int arr_size)
{
	int i;
	i = 0;
	while (i < arr_size) {
...
void print_f_array(float arr[10], int arr_size)
{
	int i;
	i = 0;
	while (i < arr_size) {
