...
readonly INTEGRATION_DIR="${INTEGRATION_DIR:-$SCRIPTS_DIR/../test/asm_integration}"

# Directory used to store integration test outputs.
readonly OUTPUT_DIR="${OUTPUT_DIR:-asm_integration_tests}"
...
{
	local test=$1
	local ex_stdout="$INTEGRATION_DIR/$test/$test.echo.txt"
