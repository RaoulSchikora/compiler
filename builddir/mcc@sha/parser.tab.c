...
#line 127 "mcc@sha/parser.tab.c" /* yacc.c:355  */
...
#line 160 "mcc@sha/parser.tab.c" /* yacc.c:355  */
};
...
#line 190 "mcc@sha/parser.tab.c" /* yacc.c:358  */
...
static const char *const yytname[] =
{
  ...
  "\"float literal\"", "\"(\"", "\")\"", "\"+\"", "\"-\"", "\"*\"",
  "\"/\"", "$accept", "toplevel", "expression", "literal", YY_NULLPTR
};
#endif
